...
//   return (
//     <div className="max-w-7xl mx-auto p-1 sm:p-4 bg-white ">
//       <div className="text-center mb-2 sm:mb-6">
//         <h1 className="text-xl sm:text-4xl  text-black font-bold mb-1 sm:mb-2">All User Reviews & Products</h1>
//         <p className="text-black text-xs sm:text-lg">
...
//         <div className="shadow-lg rounded-xl border text-black border-gray-200 bg-white overflow-hidden">
